...
import { getProducts, getCategories, createProduct, updateProduct, deleteProduct } from "@/actions/admin"
  ...
  const { data: products, isLoading } = useQuery({
    ...
    queryFn: () =>
      getProducts({
        ...
        inStock: stockFilter !== "all" ? stockFilter === "in-stock" : undefined,
      }),
  })
    ...
    <AdminLayout>
      ...
      <Dialog open={isViewDialogOpen} onOpenChange={setIsViewDialogOpen}>
        <DialogContent className="max-w-3xl">
          <DialogHeader>
            ...
            <DialogDescription>Comprehensive information about the product</DialogDescription>
          </DialogHeader>
                  ...
                  {selectedProduct.images && selectedProduct.images.length > 1 && (
                    <div className="grid grid-cols-4 gap-2 mt-2">
                      {selectedProduct.images.slice(1, 5).map((image: string, index: number) => (
                        <div key={index} className="aspect-square rounded-md bg-gray-100 overflow-hidden">
                          <img
                  ...
                  <Tabs defaultValue="details" className="mt-6">
                      ...
                      <div className="space-y-2">
                        ...
                        {selectedProduct.originalPrice && (
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm line-through">${selectedProduct.originalPrice.toFixed(2)}</span>
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm">
                            {selectedProduct.rating ? `${selectedProduct.rating.toFixed(1)} / 5` : "No ratings"}
                            {selectedProduct.reviewCount ? ` (${selectedProduct.reviewCount} reviews)` : ""}
                          </span>
                        </div>
                      </div>
                    ...
                    <TabsContent value="inventory" className="space-y-4 mt-4">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="p-4 border rounded-md">
                          <h4 className="text-sm font-medium mb-1">Stock Status</h4>
                          <div className="flex items-center gap-2">
                            <span
                        ...
                        <div className="p-4 border rounded-md">
                          ...
                          <p className="text-gray-700">{selectedProduct.sku || "Not available"}</p>
                        </div>

                        {selectedProduct.weight && (
                          <div className="p-4 border rounded-md">
                            <h4 className="text-sm font-medium mb-1">Weight</h4>
                            <p className="text-gray-700">{selectedProduct.weight}</p>
                          </div>
                        )}
                    ...
                    <TabsContent value="sales" className="space-y-4 mt-4">
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div className="p-4 border rounded-md">
                          <h4 className="text-sm font-medium mb-1">Total Sales</h4>
                          <p className="text-lg font-semibold">
                            {selectedProduct.totalSales ? `${selectedProduct.totalSales} units` : "0 units"}
                          </p>
                        </div>
                        ...
                        <div className="p-4 border rounded-md">
                          ...
                          <p className="text-lg font-semibold">
                            ${selectedProduct.revenue ? selectedProduct.revenue.toFixed(2) : "0.00"}
                          </p>
                        </div>

                        <div className="p-4 border rounded-md">
                          <h4 className="text-sm font-medium mb-1">Last Ordered</h4>
                          <p className="text-gray-700">
                            {selectedProduct.lastOrdered
                              ? new Date(selectedProduct.lastOrdered).toLocaleDateString()
                              : "Never"}
                          </p>
                        </div>
                      </div>
      ...
      <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
        <DialogContent className="max-w-2xl">
          ...
          <form onSubmit={handleCreateProduct} className="py-4 space-y-6">
                ...
                <div className="space-y-4 pt-2">
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-xs text-gray-500">Product will be visible in store</p>
                    </div>
                    <Switch
                      id="isActive"
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-xs text-gray-500">Product will be highlighted in store</p>
                    </div>
                    <Switch
                      id="isFeatured"
      ...
      <Dialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
        <DialogContent>
          ...
          <DialogFooter>
            ...
            <Button variant="destructive" onClick={handleDeleteProduct} disabled={deleteProductMutation.isPending}>
